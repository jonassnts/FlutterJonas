...
import 'package:projeto_um/quizz.dart';
...
class Homepage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Quiz do Jonas', style: GoogleFonts.nunitoSans(fontSize: 18, fontWeight: FontWeight.bold)),
        centerTitle: false,
        actions: const [
          Icon(Icons.search)
        ],
            ...
            child: GestureDetector(
              ...
              child: Card(
                ...
                children: [
                  ...
                  Text('Mostre seu conhecimento \nmaritimo!', style: GoogleFonts.indieFlower(fontSize: 24, fontWeight: FontWeight.bold)),                
                  ListTile(
            ...
            Container(
                  ...
                  color: Colors.green[50],
                      ...
                      children: [
                        Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Image.asset('assets/sapinho.png', width: 50, height: 50),
                        ),
                        Text('Mostre seu conhecimento \nterrestre!', 
                  ...
                  color: Colors.green[50],
                      ...
                      children: [
                        Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Image.asset('assets/arara.png', width: 50, height: 50),
                        ),
                        Text('Mostre seu conhecimento \naéreo!', 
                          style: GoogleFonts.indieFlower(fontSize: 16, fontWeight: FontWeight.bold)),              
                        ListTile(
